...
void fwd_bshd(int32_t B, int32_t H_Q, int32_t H_KV, int32_t S_Q, int32_t S_KV, int32_t D_QK, int32_t D_V,
              int left_sliding_window, int32_t cur_kv_seq_len, const __QDType* __restrict__ __q, __KDType** __k, __VDType** __v,
              __AccDType* __s_aux, __ODType* __restrict__ __out, int32_t thread_count) {
