...
static std::array<const char*, 13> sg_opNames{{"LLaMAReLU", "SplitInput", "KVCache", "CausalMask", "HeadMatmul", "RMSNorm", "WNop", "MergeOutput", "RoPE", "LLaMAAdd", "Attention", "LLaMAMul", "SiLU"}};
