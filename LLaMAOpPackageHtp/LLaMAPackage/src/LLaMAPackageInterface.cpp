...
static std::array<const char*, 16> sg_opNames{{"RoPE", "LLaMAQuantize", "LLaMAMul", "LLaMAAdd", "RMSNorm", "SplitInput", "CausalMask", "Attention", "KVCache", "LLaMAReLU", "MergeOutput", "QLayerNorm", "LLaMADequantize", "HeadMatmul", "WNop", "SiLU"}};
