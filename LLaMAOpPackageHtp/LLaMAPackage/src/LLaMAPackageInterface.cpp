...
static std::array<const char*, 13> sg_opNames{{"WNop", "Attention", "SiLU", "KVCache", "SplitInput", "LLaMAMul", "CausalMask", "MergeOutput", "RMSNorm", "LLaMAAdd", "HeadMatmul", "RoPE", "LLaMAReLU"}};
