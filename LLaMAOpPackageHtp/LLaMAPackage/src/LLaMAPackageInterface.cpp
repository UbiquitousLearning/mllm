...
static std::array<const char*, 17> sg_opNames{{"MergeOutput", "QLayerNorm", "CausalMask", "LLaMAMul", "RMSNorm", "Attention", "KVCache", "LLaMAAdd", "LLaMALinear", "LLaMAQuantize", "LLaMAReLU", "HeadMatmul", "LLaMADequantize", "WNop", "SplitInput", "RoPE", "SiLU"}};
