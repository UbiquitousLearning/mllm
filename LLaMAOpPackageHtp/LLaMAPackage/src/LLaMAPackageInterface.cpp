...
static std::array<const char*, 17> sg_opNames{{"SplitInput", "SiLU", "WNop", "Attention", "LLaMAReLU", "LLaMAQuantize", "CausalMask", "KVCache", "QLayerNorm", "LLaMALinear", "HeadMatmul", "MergeOutput", "LLaMAAdd", "RMSNorm", "RoPE", "LLaMADequantize", "LLaMAMul"}};
...
Qnn_ErrorHandle_t LLaMAPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "SplitInput"){
