...
static std::array<const char*, 13> sg_opNames{{"KVCache", "MergeOutput", "SplitInput", "RMSNorm", "SiLU", "CausalMask", "RoPE", "LLaMAReLU", "HeadMatmul", "LLaMAMul", "WNop", "LLaMAAdd", "Attention"}};
