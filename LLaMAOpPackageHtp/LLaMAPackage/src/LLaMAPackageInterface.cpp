...
static std::array<const char*, 15> sg_opNames{{"LLaMAAdd", "Attention", "RMSNorm", "WNop", "LLaMAQuantize", "LLaMAMul", "RoPE", "QLayerNorm", "MergeOutput", "SplitInput", "LLaMAReLU", "SiLU", "CausalMask", "HeadMatmul", "KVCache"}};
...
Qnn_ErrorHandle_t LLaMAPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "LLaMAAdd"){
