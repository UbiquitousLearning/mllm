...
static std::array<const char*, 14> sg_opNames{{"RoPE", "LLaMAAdd", "LLaMAMul", "WNop", "QLayerNorm", "KVCache", "SiLU", "SplitInput", "HeadMatmul", "Attention", "RMSNorm", "CausalMask", "MergeOutput", "LLaMAReLU"}};
