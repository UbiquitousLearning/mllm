...
int main(int argc, char **argv) {
    ...
    cmdParser.add<string>("vocab", 'v', "specify mllm tokenizer model path", false, "/media/wch/F897B8BA125F3169/llm/Yi-1.5-6B-Chat/yi_vocab.mllm");
    cmdParser.add<string>("model", 'm', "specify mllm model path", false, "/media/wch/F897B8BA125F3169/llm/Yi-1.5-6B-Chat/Yi-1.5-6B_q4_k.mllm");
