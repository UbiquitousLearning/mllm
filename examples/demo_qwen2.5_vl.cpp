...
#ifdef ARM
    cmdParser.add<string>("model", 'm', "specify mllm model path", false, "../models/qwen-2.5-vl-3b-instruct-kai_q4_0_f.mllm");
#else
    cmdParser.add<string>("model", 'm', "specify mllm model path", false, "../models/qwen-2-vl-2b-instruct-q4_k.mllm");
#endif
    cmdParser.add<string>("billion", 'b', "[3B | 7B |]", false, "3B");
