...
./build-qnn-aot/bin/mllm-qwen2vl-aot-c \
  --model_path path/to/qwen2vl-qnn-lpbq.mllm \
  --config examples/qwen2vl/config_2B_qnn_lpbq.json \
  --aot_config examples/qwen2vl/qnn_aot_cfg_2B.json \
  --output_context_name qwen2vl-full-qnn.bin \
  --context_len 1024 \
  --prefill_len 32 \
  --include_visual_bundle \
  --visual_model path/to/qwen2vl-visual.mllm \
  --visual_config examples/qwen2vl/config_2B_qnn_lpbq.json \
  --visual_aot_config examples/qwen2vl/qnn_aot_cfg_2B_visual.json \
...
CONTEXT=models/qwen2vl-full-qnn.bin \
QNN_PARAMS=models/qwen2vl-qnn-lpbq.mllm \
