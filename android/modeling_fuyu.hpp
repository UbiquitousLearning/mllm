...
#include "math.h"
#include "helper.hpp"
NetTensor *Attention_Fuyu(Context *ctx, NetTensor * x, int embedding_size, int hidden_size, int head_size, string name){
...
NetTensor *MLP_Fuyu(Context *ctx, NetTensor * i, int hidden_dim, int ffn_hidden_dim, string name){
