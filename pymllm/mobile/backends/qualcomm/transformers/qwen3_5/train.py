...
from pymllm.mobile.backends.qualcomm.transformers.qwen3_5.runner import Qwen3_5Quantizer


def main():
    parser = argparse.ArgumentParser(description="Qwen3.5 Quantizer for Qualcomm backend")
    parser.add_argument(
        "--model_path",
        type=str,
    ...
    m = Qwen3_5Quantizer(args.model_path, mllm_qualcomm_max_length=args.max_length)
