...
def main():
    parser = argparse.ArgumentParser(description="Qwen2 Quantizer for Qualcomm backend")
    parser.add_argument(
        "--model_path",
        type=str,
        default="Qwen/Qwen2-1.5B",
        help="Path to the Qwen2 model directory",
    )
    parser.add_argument(
        "--max_length",
        type=int,
    ...
    m = Qwen2Quantizer(args.model_path, mllm_qualcomm_max_length=args.max_length)
