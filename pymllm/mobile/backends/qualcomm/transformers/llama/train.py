...
def main():
    parser = argparse.ArgumentParser(description="Llama Quantizer for Qualcomm backend")
    parser.add_argument(
        "--model_path",
        type=str,
        default="",
    ...
    m = LlamaQuantizer(args.model_path, mllm_qualcomm_max_length=args.max_length)
