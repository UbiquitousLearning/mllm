...
public:
    ...
    string _gate_proj_name = "gate_proj";
    void init_qwen2vl() {
...
public:
    ...
    int visiion_intermediate_size;
    int spatial_merge_size = 2;
    int spatial_patch_size = 14;
    int window_size = 112;
    ...
    vector<int> fullatt_block_indexes = {7, 15, 23, 31};

    Qwen2VLNameConfig vision_names_config;
    Qwen2VLConfig(int token_limit, string billions = "3b", RoPEType type = HFHUBROPE, int vocab = 32064, string project_cls = "MLP") :
        QWenConfig(token_limit, billions, type) {
        // names_config.init(type);
        projection_cls = project_cls;
        vision_embed_dim = 1280;
        visiion_intermediate_size = 3420;
