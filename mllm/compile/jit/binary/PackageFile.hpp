...
// A Package is composed by 7 components:
// 1. A Header File (generated by compiler, binary format)
// 2. A Tuning File (generated by compiler, json foramt, optional)
// 3. An IR Source File (generated by compiler, pure text)
// 4. A Model Config File (from user, json format file)
// 5. A Tokenizer File (from user, json format file)
// 6. Other custom files (from user, binary format)
...
static_assert(sizeof(PackageFileV1HeaderFile) == 1080, "PackageFileV1HeaderFile size mismatch");
