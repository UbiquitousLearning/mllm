...
namespace mllm::cpu::arm::fp32_channel_a8_weight_group_ux::kernel {
namespace internal {
...
void kernel_1x8x16_f32_neondot(
    ...
    float clamp_min, float clamp_max, bool has_bias, bool has_clamp) {
    ...
    for (int n_idx = 0; n_idx < n; n_idx += 8) {
      ...
      for (int k_idx = 0; k_idx < k; k_idx += group_size) {
        ...
        for (int i = 0; i < group_size; i += 16) {
          ...
          if constexpr (has_lut) {
            bitspack::vec_unpack_128_lowbit_values_with_lut<weight_nbit>(
                weight_q_cols01_0, weight_q_cols23_0, weight_q_cols45_0, weight_q_cols67_0, weight_q_cols01_1,
                weight_q_cols23_1, weight_q_cols45_1, weight_q_cols67_1, (uint8_t*)weight_data_byte_ptr, lut);
          } else {
            bitspack::vec_unpack_128_lowbit_values<weight_nbit>(
                weight_q_cols01_0, weight_q_cols23_0, weight_q_cols45_0, weight_q_cols67_0, weight_q_cols01_1,
                weight_q_cols23_1, weight_q_cols45_1, weight_q_cols67_1, (uint8_t*)weight_data_byte_ptr);
          }
