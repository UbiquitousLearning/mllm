...
MLLM_CPU_ARM_FORCE_INLINE void pack_8_uint7_values(uint8_t* packed, const uint8_t* unpacked) {
...
MLLM_CPU_ARM_FORCE_INLINE void unpack_8_uint7_values(uint8_t* unpacked, const uint8_t* packed) {
  // Unpacks 8 uint7 vales packed by pack_8_uint7_values.
  // Load the 7 packed bytes into vector.
  uint8_t temp[8] = {packed[0],    packed[1], packed[2], packed[3], packed[4], packed[5], packed[6],
                     /*ignored*/ 0};
  ...
  unpacked[7] = vaddv_u8(vshl_u8(vand_u8(v, vdup_n_u8(0b1000'0000u)), vld1_s8(shift)));
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_64_uint7_values(uint8_t* packed, const uint8x16_t& unpacked0,
  ...
  vst1_u8(packed + 8, vsli_n_u8(vget_high_u8(unpacked0), vshr_n_u8(last, 1), 7));
  // Pack bit 5 from 0123 4567, etc.
  vst1_u8(packed + 16, vsli_n_u8(vget_low_u8(unpacked1), vshr_n_u8(last, 2), 7));
  vst1_u8(packed + 24, vsli_n_u8(vget_high_u8(unpacked1), vshr_n_u8(last, 3), 7));
  vst1_u8(packed + 32, vsli_n_u8(vget_low_u8(unpacked2), vshr_n_u8(last, 4), 7));
  vst1_u8(packed + 40, vsli_n_u8(vget_high_u8(unpacked2), vshr_n_u8(last, 5), 7));
  vst1_u8(packed + 48, vsli_n_u8(vget_low_u8(unpacked3), vshr_n_u8(last, 6), 7));
}

MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_64_uint7_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_128_uint7_values(uint8_t* packed, const uint8x16_t& unpacked0,
                                                         const uint8x16_t& unpacked1, const uint8x16_t& unpacked2,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_128_uint7_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
