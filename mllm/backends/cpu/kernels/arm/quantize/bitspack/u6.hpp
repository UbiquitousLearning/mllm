...
MLLM_CPU_ARM_FORCE_INLINE void pack_4_uint6_values(uint8_t* packed, const uint8_t* unpacked) {
...
MLLM_CPU_ARM_FORCE_INLINE void unpack_4_uint6_values(uint8_t* unpacked, const uint8_t* packed) {
  ...
  // Last value is packed in the upper 2 bits of the three bytes
  unpacked[3] = ((packed[0] & 0b1100'0000u) >> 6) | ((packed[1] & 0b1100'0000u) >> 4) | ((packed[2] & 0b1100'0000u) >> 2);
}

MLLM_CPU_ARM_FORCE_INLINE void vec_pack_32_uint6_values(uint8_t* packed, const uint8x16_t& unpacked0,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_32_uint6_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, const uint8_t* packed) {
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_64_uint6_values(uint8_t* packed, const uint8x16_t& unpacked0,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_64_uint6_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
