...
MLLM_CPU_ARM_FORCE_INLINE void pack_8_uint3_values(uint8_t* packed, const uint8_t* unpacked) {
  ...
  // b2
  packed[2] = ((unpacked[6] & 4) << 5) | ((unpacked[7] & 4) << 4) | ((unpacked[4] & 7) << 3) | unpacked[5];
}

MLLM_CPU_ARM_FORCE_INLINE void unpack_8_uint3_values(uint8_t* unpacked, const uint8_t* packed) {
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_64_uint3_values(uint8_t* packed,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_64_uint3_values(uint8x16_t& unpacked0,  // 0, 1
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_128_uint3_values(uint8_t* packed, const uint8x16_t& unpacked0,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_128_uint3_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
