...
MLLM_CPU_ARM_FORCE_INLINE void pack_8_uint5_values(uint8_t* packed, const uint8_t* unpacked) {
  ...
  packed[4] = (unpacked[1] >> 3) | ((unpacked[3] >> 3) << 2) | ((unpacked[5] >> 3) << 4) | ((unpacked[7] >> 3) << 6);
}

MLLM_CPU_ARM_FORCE_INLINE void unpack_8_uint5_values(uint8_t* unpacked, const uint8_t* packed) {
...
MLLM_CPU_ARM_FORCE_INLINE void vec_pack_64_uint5_values(uint8_t* packed, const uint8x16_t& unpacked0,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_64_uint5_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
  ...
  unpacked1 = vcombine_u8(vshl_n_u8(vand_u8(p2, vdup_n_u8(0b00000011)), 3), vshl_n_u8(vand_u8(p2, vdup_n_u8(0b00001100)), 1));
  unpacked1 = vorrq_u8(unpacked1, vshrq_n_u8(p0, 5));
  unpacked2 = vandq_u8(p1, vdupq_n_u8(0b11111));
  unpacked3 = vcombine_u8(vshr_n_u8(vand_u8(p2, vdup_n_u8(0b00110000)), 1), vshr_n_u8(vand_u8(p2, vdup_n_u8(0b11000000)), 3));
  unpacked3 = vorrq_u8(unpacked3, vshrq_n_u8(p1, 5));
}

MLLM_CPU_ARM_FORCE_INLINE void vec_pack_128_uint5_values(uint8_t* packed, const uint8x16_t& unpacked0,
                                                         const uint8x16_t& unpacked1, const uint8x16_t& unpacked2,
...
MLLM_CPU_ARM_FORCE_INLINE void vec_unpack_128_uint5_values(uint8x16_t& unpacked0, uint8x16_t& unpacked1, uint8x16_t& unpacked2,
  ...
  unpacked0 = vandq_u8(p0, vdupq_n_u8(0b11111));
  unpacked1 = vorrq_u8(vshrq_n_u8(p0, 5), vshlq_n_u8(vandq_u8(p4, vdupq_n_u8(0b00000011)), 3));
  unpacked2 = vandq_u8(p1, vdupq_n_u8(0b11111));
  unpacked3 = vorrq_u8(vshrq_n_u8(p1, 5), vshlq_n_u8(vandq_u8(p4, vdupq_n_u8(0b00001100)), 1));
  unpacked4 = vandq_u8(p2, vdupq_n_u8(0b11111));
  unpacked5 = vorrq_u8(vshrq_n_u8(p2, 5), vshrq_n_u8(vandq_u8(p4, vdupq_n_u8(0b00110000)), 1));
