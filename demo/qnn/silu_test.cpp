...
NetTensor * SiLU(Context *ctx,  uint32_t hidden_dim, uint32_t ffn_hidden_dim) {
...
int main() {
    ...
    SiLU(c, hidden_dim, ffn_hidden_dim);
    ...
    seqTensor(input, net, {4, 2, 4, ffn_hidden_dim}, -7.23f);
    // fullTensor(input, net, {4, 2, 4, ffn_hidden_dim}, 2.f);
