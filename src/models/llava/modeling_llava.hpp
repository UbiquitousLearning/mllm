...
public:
    ...
    LLaMABodyModel(int vocab_size, int hidden_dim, int head_size, int ffn_hidden, int block_num, RoPEType RoPE_type, int cache_limit,
...
public:
    explicit LLaVAModel(const LLaVAConfig &config) :
        LLaVAModel(config.vocab_size, config.hidden_dim, config.head_size, config.ffn_hidden, config.block_num, config.RoPE_type, config.cache_limit,
                   config.names_config,
    ...
    LLaVAModel(int vocab_size, int hidden_dim, int head_size, int ffn_hidden, int block_num, RoPEType RoPE_type, int cache_limit,
        ...
        llama_body = LLaMABodyModel(vocab_size, hidden_dim, head_size, ffn_hidden, block_num, RoPE_type, cache_limit,
