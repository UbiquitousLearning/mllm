 ...
 *
 */
#ifndef CONFIG_QWEN2_5_HPP
#define CONFIG_QWEN2_5_HPP
#include "Types.hpp"
...
class QWen2_5NameConfig : public TransformerNameConfig {
public:
    /**
     * @brief QWen2.5 following the hugging face naming method
     *
     * @param type RoPEType
     */
...
struct QWen2_5Config {
    explicit QWen2_5Config(int token_limit, string billions = "0.5B", RoPEType type = RoPEType::HFHUBROPE) :
    ...
    QWen2_5NameConfig names_config;
};

#endif //! CONFIG_QWEN2_5_HPP
