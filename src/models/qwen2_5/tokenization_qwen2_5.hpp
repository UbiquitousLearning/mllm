 ...
 *
 */
#ifndef TOKENIZATION_QWEN2_5_HPP
#define TOKENIZATION_QWEN2_5_HPP
...
class QWen2_5Tokenizer final {
public:
    explicit QWen2_5Tokenizer(const std::string &vocab_file, const std::string &merge_file, bool split_special_tokens = false) :
...
#endif //! TOKENIZATION_QWEN2_5_HPP