...
static std::array<const char*, 18> sg_opNames{{"CausalMask", "SiLU", "SplitInput", "Attention", "RoPE", "LLaMAMul", "WNop", "RMSNorm", "HeadMatmul", "LLaMALinear", "LLaMAAdd", "LLaMADequantize", "LLaMAReLU", "KVCache", "LLaMAQuantize", "LLaMASuperSiLU", "MergeOutput", "QLayerNorm"}};
...
Qnn_ErrorHandle_t LLaMAPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "CausalMask"){
