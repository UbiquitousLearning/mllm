...
static std::array<const char*, 18> sg_opNames{{"MergeOutput", "SplitInput", "SiLU", "LLaMALinear", "KVCache", "RoPE", "WNop", "LLaMAAdd", "QLayerNorm", "CausalMask", "HeadMatmul", "LLaMAReLU", "LLaMAMul", "LLaMAQuantize", "RMSNorm", "LLaMADequantize", "LLaMASuperSiLU", "Attention"}};
...
Qnn_ErrorHandle_t LLaMAPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "MergeOutput"){
