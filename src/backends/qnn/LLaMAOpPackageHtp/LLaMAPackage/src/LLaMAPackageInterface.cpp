...
static std::array<const char*, 18> sg_opNames{{"SiLU", "CausalMask", "MergeOutput", "RoPE", "LLaMASuperSiLU", "SplitInput", "RMSNorm", "LLaMADequantize", "WNop", "HeadMatmul", "LLaMAAdd", "Attention", "LLaMAMul", "LLaMALinear", "QLayerNorm", "LLaMAQuantize", "LLaMAReLU", "KVCache"}};
