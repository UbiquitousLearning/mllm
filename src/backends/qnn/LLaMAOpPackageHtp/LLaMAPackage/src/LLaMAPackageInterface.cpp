...
static std::array<const char*, 18> sg_opNames{{"LLaMALinear", "LLaMASuperSiLU", "KVCache", "QLayerNorm", "LLaMAQuantize", "WNop", "LLaMAMul", "Attention", "LLaMADequantize", "CausalMask", "HeadMatmul", "SplitInput", "SiLU", "MergeOutput", "LLaMAReLU", "RMSNorm", "RoPE", "LLaMAAdd"}};
...
Qnn_ErrorHandle_t LLaMAPackageValidateOpConfig (Qnn_OpConfig_t opConfig){
     ...
     */
    if (std::string(opConfig.v1.typeName) == "LLaMALinear"){
