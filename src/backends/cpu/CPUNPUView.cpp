...
CPUNPUView::CPUNPUView(Backend *bn, string opName, vector<int> dims, vector<int> data_dims, int threadCount) :
...
ErrorCode CPUNPUView::reshape(vector<shared_ptr<Tensor>> inputs, vector<shared_ptr<Tensor>> outputs) {
    // if(data_dim4_ != -999) {
...
ErrorCode CPUNPUView::execute(vector<shared_ptr<Tensor>> inputs, vector<shared_ptr<Tensor>> outputs) {
    if (noNeedEx_) {
...
ErrorCode CPUNPUView::setUp(vector<shared_ptr<Tensor>> inputs, vector<shared_ptr<Tensor>> outputs) {
