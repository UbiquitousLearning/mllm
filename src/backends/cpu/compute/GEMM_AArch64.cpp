...
void quantize_q8_0_4x4(const float *__restrict x, void *__restrict vy,
                       int64_t k) {
  assert(QK8_0 == 32);
  assert(k % QK8_0 == 0);
...
void quantize_q8_0_4x8(const float *__restrict x, void *__restrict vy,
                       int64_t k) {
  assert(QK8_0 == 32);
  assert(k % QK8_0 == 0);
  const int nb = k / QK8_0;
...
void quantize_mat_q8_0(const float *__restrict x, void *__restrict vy,
...
static size_t quantize_q4_0_nr_bl(const float *__restrict src,
                                  void *__restrict dst, int64_t nrow,
  ...
  for (int b = 0; b < (nrow * n_per_row); b += nrows_interleaved * n_per_row) {
    for (int64_t x = 0; x < nb; x++) {
      for (int i = 0; i < nrows_interleaved; i++) {
        quantize_row_q4_0(src + b + i * n_per_row + x * QK4_0,
...
size_t quantize_q4_0_4x4(const float *__restrict src, void *__restrict dst,
                         int64_t nrows, int64_t n_per_row,
                         const float *imatrix) {
  if (imatrix != nullptr) {
    return quantize_q4_0_nr_bl(src, dst, nrows, n_per_row, 4, 4);
  }
  assert(false);
  return 0;
}

size_t quantize_q4_0_4x8(const float *__restrict src, void *__restrict dst,
                         int64_t nrows, int64_t n_per_row,
                         const float *imatrix) {
  if (imatrix == nullptr) {
    return quantize_q4_0_nr_bl(src, dst, nrows, n_per_row, 4, 8);
  }
  assert(false);
  return 0;
}

size_t quantize_q4_0_8x8(const float *__restrict src, void *__restrict dst,
                         int64_t nrows, int64_t n_per_row,
                         const float *imatrix) {
  if (imatrix == nullptr) {
    return quantize_q4_0_nr_bl(src, dst, nrows, n_per_row, 8, 8);
  }
  assert(false);
  return 0;
}

void mllm_gemv_q4_0_4x4_q8_0(int n, float *__restrict s, size_t bs,
    ...
    for (int l = 0; l < nb; l++) {
      for (int k = 0; k < (qk / (2 * blocklen)); k++) {
        for (int j = 0; j < ncols_interleaved; j++) {
          ...
          sumf[j] += sumi * MLLM_FP16_TO_FP32(b_ptr[l].d[j]) *
                     MLLM_FP16_TO_FP32(a_ptr[l].d);
        }
      }
    }
    for (int j = 0; j < ncols_interleaved; j++)
...
void _mllm_gemv_q4_0_4x4_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void mllm_gemv_q4_0_4x8_q8_0(int n, float *__restrict s, size_t bs,
                             const void *__restrict vx,
                             const void *__restrict vy, int nr, int nc,
                             const void *__restrict bias) {
  if (bias != nullptr) {
...
void _mllm_gemv_q4_0_4x8_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void mllm_gemv_q4_0_8x8_q8_0(int n, float *__restrict s, size_t bs,
                             const void *__restrict vx,
                             const void *__restrict vy, int nr, int nc,
                             const void *__restrict bias) {
  if (bias != nullptr) {
...
void _mllm_gemv_q4_0_8x8_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void mllm_gemm_q4_0_4x4_q8_0(int n, float *__restrict s, size_t bs,
                             const void *__restrict vx,
                             const void *__restrict vy, int nr, int nc,
                             const void *__restrict bias) {
  if (bias != nullptr) {
...
void _mllm_gemm_q4_0_4x4_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void mllm_gemm_q4_0_4x8_q8_0(int n, float *__restrict s, size_t bs,
                             const void *__restrict vx,
                             const void *__restrict vy, int nr, int nc,
                             const void *__restrict bias) {
  if (bias != nullptr) {
...
void _mllm_gemm_q4_0_4x8_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void mllm_gemm_q4_0_8x8_q8_0(int n, float *__restrict s, size_t bs,
                             const void *__restrict vx,
                             const void *__restrict vy, int nr, int nc,
                             const void *__restrict bias) {
  if (bias != nullptr) {
...
void _mllm_gemm_q4_0_8x8_q8_0_bias(int n, float *__restrict s, size_t bs,
                                   const void *__restrict vx,
                                   const void *__restrict vy, int nr, int nc,
                                   const void *__restrict bias) {
  const int qk = QK8_0;
...
void quantize_row_q4_0_4x4(const float *__restrict x, void *__restrict y,
                           int k) {
  assert(k % QK4_0 == 0);
