...
#ifndef MLLM_CPUNPUVIEW_H
#define MLLM_CPUNPUVIEW_H
...
class CPUNPUView final : public Op {
public:
    CPUNPUView(Backend *bn, string opName, vector<int> dims, vector<int> data_dims, int threadCount);
    virtual ~CPUNPUView() = default;
...
class CPUNPUViewCreator : public CPUBackend::Creator {
public:
    virtual Op *create(OpParam op_param, Backend *bn, string name, int threadCount) const {
        ...
        return new CPUNPUView(bn, name, dims, data_dims, threadCount);
    }
};
