...
public:
    CPUAvgPool2D(Backend *bn, string opName,  vector<int> kernal_size, vector<int> stride, PaddingType padding_type, bool multiThread);
...
public:
    virtual Op *create(OpParam op_param, Backend *bn, string name) const {
        ...
        return new CPUAvgPool2D(bn, name, kernal_size, stride, padding_type, false);
    }
};
